  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">the intricacies of Machine Learning and Natural Langauge Processing</span>.{" "}
      ...
      <p>
        ...
        learning to{" "}
        <span className="font-medium">cook different cousins </span>. I'm also
